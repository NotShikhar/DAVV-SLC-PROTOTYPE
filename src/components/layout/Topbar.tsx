...
function LanguageToggle() {
  ...
  return (
    <div className="hidden items-center rounded-btn border border-line p-0.5 sm:flex" role="group" aria-label="Language">
      {options.map((l) => (
        <button
          key={l}
          type="button"
          ...
          className={cn(
            ...
            locale === l ? "bg-navy text-white" : "text-muted hover:text-navy",
          )}
        >
          {l.toUpperCase()}
        </button>
      ...
      <div className="flex h-16 items-center justify-between gap-3 px-4 sm:px-6">
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-lg p-2 text-slate hover:bg-cream hover:text-navy lg:hidden"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          {role === "student" && (
            <Link
              ...
              className="relative rounded-lg p-2 text-slate hover:bg-cream hover:text-navy"
            >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-lg p-1 pr-2 hover:bg-cream"
              aria-haspopup="menu"
